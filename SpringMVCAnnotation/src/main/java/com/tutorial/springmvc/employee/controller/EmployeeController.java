package com.tutorial.springmvc.employee.controller;
...
//		System.out.println("EmployeeController.initForm()" + request.getSession().getId());
	public String initForm(ModelMap model) {
		...
		cust.setUserName("rukmini");
		cust.setFavFramework(new String[] { "Spring MVC","JSF" });
		cust.setSex("M");
		cust.setReceiveNewsletter(true);
